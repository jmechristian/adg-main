...
const HomeFeatured = () => {
  return (
    <div className='w-full bg-brand-peach grid grid-cols-12'>
      ...
      ></div>
      <div className='col-span-12 md:col-span-5 flex flex-col gap-10 py-36 px-12'>
        <div className='text-brand-brown text-xl font-brand-book font-light uppercase tracking-[0.3rem] text-center'>
          Featured Work
        </div>
        <div className='flex flex-col gap-4'>
          <div className='text-brand-gray text-6xl font-brand italic text-center leading-tight'>
            <span>The Ritz-Carlton Residences</span>
          </div>
          <div className='text-brand-gray text-4xl font-light font-brand text-center leading-snug'>
        ...
        <div className='w-full flex justify-center items-center gap-2'>
          <div className='text-brand-gray text-2xl font-brand font-light uppercase tracking-[0.3rem]'>
            Discover
          </div>
          <div>
